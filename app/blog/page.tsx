      ...
      <header className="bg-white py-4 border-b border-gray-100">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12 flex items-center justify-between w-full">
          ...
          <div className="flex-1 max-w-2xl mx-12 hidden md:block">
            <div className="relative">
              <input
                id="search-input"
                type="text"
                placeholder="Search updates, enhancements, and features..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                onFocus={() => setSearchFocused(true)}
                onBlur={() => setSearchFocused(false)}
                className={`w-full h-[46px] pl-6 pr-14 text-sm text-gray-700 border rounded-full focus:outline-none transition-all duration-300 ${
                  searchFocused ? "border-[#374bf9] ring-2 ring-[#374bf9]/10 bg-white" : "border-gray-200 bg-[#f9f9fb]"
                }`}
              />
          ...
          <div className="flex items-center gap-x-6 text-sm font-medium text-gray-800">
            ...
            <button className="hover:text-[#374bf9] transition-colors font-medium">
              Login / Register
            </button>
          </div>
        </div>
      ...
      <nav className="bg-[#faba5b] py-3 text-[14px] font-medium text-black">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12 flex items-center justify-between w-full">
          <ul className="flex flex-wrap items-center gap-y-2 gap-x-6">
            ...
            <li><a href="/shop" className="hover:text-gray-700 font-semibold transition-colors">Shop Catalog</a></li>
            <li><a href="/about" className="hover:text-gray-700 transition-colors">About Us</a></li>
            ...
            <li><a href="/bulk-orders" className="hover:text-gray-700 transition-colors">Bulk Orders</a></li>
            <li><a href="/blog" className="text-[#374bf9] font-bold">Blog</a></li>
            ...
            <li><a href="#" className="hover:text-gray-700 transition-colors">FAQs</a></li>
          </ul>
