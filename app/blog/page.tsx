...
export default async function BlogPage() {
  ...
  try {
    ...
    if (categoriesRes.ok) {
      ...
      // Only keep categories that have articles and exclude default ones if necessary
      categories = allCats.filter((c: any) => c.count > 0 && c.name.toLowerCase() !== "uncategorized");
    }
  } catch (err) {
